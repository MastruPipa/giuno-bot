...
var AGENT_TOOL_SETS = {
  ...
  crmUpdate: ['search_leads', 'crm_compare', 'update_lead', 'create_lead', 'delete_lead', 'recall_memory', 'list_projects', 'update_project', 'create_project', 'attio_search', 'attio_get_record', 'attio_create_record', 'attio_update_record', 'attio_add_note'],
