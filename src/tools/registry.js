...
var AGENT_TOOL_SETS = {
  ...
  clientRetrieval: ['recall_memory', 'search_kb', 'search_drive', 'search_slack_messages', 'search_everywhere', 'ask_gemini', 'list_channels', 'summarize_channel', 'get_pinned_messages'],
