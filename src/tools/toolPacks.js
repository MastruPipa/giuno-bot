...
var PACKS = [
  ...
  { name: 'crm_write', label: 'aggiornare CRM, lead, deal e note Attio', tools: ['update_lead', 'create_lead', 'delete_lead', 'query_leads_db', 'attio_create_record', 'attio_update_record', 'attio_add_note', 'pipeline_review'],
    match: /\b(lead|crm|attio|deal|pipeline|trattativ\w|prospect|contatt\w|nuovo cliente|stage|won|lost|chiuso|firmat\w|follow.?up|€|euro)\b/i },
  ...
  { name: 'team_admin', label: 'team (ingressi/uscite), Google, preferenze, feedback, daily (anche postare quello scritto in chat) e planner forzati, costi', tools: ['team_member_joined', 'team_member_left', 'send_google_link', 'set_user_prefs', 'update_user_profile', 'get_connected_users', 'start_feedback', 'get_feedback_results', 'set_feedback_questions', 'trigger_daily_request', 'trigger_checkin_request', 'trigger_planner_request', 'post_daily', 'get_api_costs', 'cancel_campaign', 'get_team_presence', 'analyze_team_activity'],
