...
const columns={
  ...
  standup_entries:'id,slack_user_id,date,oggi_tasks,source',
  giunos_daily_reviews:'id,slack_user_id,date,basis_entry_id,basis_hash,status,tasks,source_urls,note,reviewed_at',
  daily_estimate_calibration:'id,slack_user_id,date,estimated_hours,actual_hours,confirmed',
  standup_data:'id,stime',
