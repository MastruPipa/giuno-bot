...
|---|---|---|---|---|
| Codex | C/D (ingresso planner e matcher cliente; G completata; nessuna riscrittura lifecycle) | `feat/gambino-client-hierarchy` | 12/9 | pilota completato e testato; pubblicazione bloccata da approvazione automatica |
| Claude | D (commessa dal contesto: `src/services/projectContext.js`, matcher, planner, dedup) | `claude/hopeful-dijkstra-uq0ulb` / nuova PR | 12/9 | in attesa di merge |
