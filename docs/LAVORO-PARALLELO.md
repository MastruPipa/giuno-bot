...
|---|---|---|---|---|
| Codex | C/D (ingresso planner e matcher cliente; G completata; nessuna riscrittura lifecycle) | `feat/gambino-client-hierarchy` / #153 | 12/9 | 18/9: riallineamento a main e verifica database, identità canoniche e protezione decisioni admin in corso |
