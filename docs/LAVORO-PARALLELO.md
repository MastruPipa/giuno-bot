...
| Claude | C + B ("Modifico nel modulo" precompilato anche dal daily salvato; bottone "Scrivo a testo libero" con parser AI) | `claude/clever-planck-8jyk6u` | 22/9 | pushato, in attesa di merge |
