...
| Claude | C (daily 16:00 non arrivato a tutti: id univoci dei bottoni rapidi, modulo semplice se Slack rifiuta il DM, avviso agli admin) | `claude/daily-delivery-issue-l79lx8` | 14/9 | in corso |
