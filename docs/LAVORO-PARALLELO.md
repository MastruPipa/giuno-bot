...
| Claude | C + B (daily scritto a mano postato su richiesta: `extractDailyFromRequest`, tool `post_daily`, percorso diretto in DM e in #daily) | `claude/serene-mayer-nur97z` | 17/9 | pushato, in attesa di merge |
